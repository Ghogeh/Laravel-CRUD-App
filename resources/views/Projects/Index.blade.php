    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="float-left">
                <a class="btn btn-success rounded-4"  href="{{ route('logout') }}" title="Logout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout <i class="fas fa-logout"></i>
                    </a>
